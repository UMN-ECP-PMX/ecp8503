...
::: {.column width="20%"}
<!-- -   Forward selection -->
<!--     -   1st round: start with base model -->
<!--         -   Base model -\> Add one covariate -\> Significantly better? -\> Yes, record a P value.  -->
<!--         -   Base model -\> Add another covariate -\> Significantly better? -\> No, not selected -->
<!--         -   ...retain the most significant covariate -->
<!--     -   2nd round: start with base model + the most significant covariate in first round -->
<!--         -   Base model -\> Add one covariate -\> Significantly better? -\> Yes, record a P value.  -->
<!--         -   Base model -\> Add another covariate -\> Significantly better? -\> No, not selected -->
<!--         -   ...retain the most significant covariate -->
<!--     -   3rd round: start with base model + the most significant covariate in first two rounds -->
<!--     -   ... -->

<!-- -   Backward Elimination -->
<!--     -   1st round: start with full model after forward selection -->
<!--         -   Full model[^1] -\> remove one covariate -\> significantly worse?[^2] -\> Yes, retained. -->
<!--         -   Full model -\> remove another covariate -\> significantly worse? -\> No, record a P value.  -->
<!--         -   ...remove the least significant covariate -->
<!--     -   2nd round: start with full model - the least significant covariate in first round -->
<!--         -   Full model -\> remove one covariate -\> significantly worse?[^2] -\> Yes, retained. -->
<!--         -   Full model -\> remove another covariate -\> significantly worse? -\> No, record a P value.  -->
<!--         -   ...remove the least significant covariate -->
<!--     -   3rd round: start with full model - the least significant covariate in first two rounds -->
<!--     -   ... -->
...
[^1]: Full model: the model include all covariates screened in forward selection.
...
-   If WT=1, Model 1 equals model 2, but WT is a variable, not a parameter.  
