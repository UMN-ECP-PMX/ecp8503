...
\begin{tabular}[h]{>{\raggedright\arraybackslash}p{7cm}lllllll}
\hline
\textbf{DOSE} & \textbf{FORM} & \textbf{N} & \textbf{WT} & \textbf{CRCL} & \textbf{AGE} & \textbf{ALB} & \textbf{SCR} \\
\hline
\multicolumn{8}{l}{\textbf{12-DEMO-001}}\\%--pmtables-insert-panel
...
\hline \multicolumn{8}{l}{\textbf{12-DEMO-002}}\\%--pmtables-insert-panel
...
\item Source code: scripts/tables.R
\item Source file: tbl-summary.tex
\end{tablenotes}
\end{threeparttable}
