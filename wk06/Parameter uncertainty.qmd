...
## LLP implementations in PsN{style="font-size: 1em"}
...
## Non-parametric bootstrap implementations in PsN{style="font-size: 1em"}
...
## Where to find a SIR Proposal distribution?{style="font-size: 1em"}
...
## SIR diagnostics[^8]{style="font-size: 1em"}
...
## SIR diagnostics[^9]{style="font-size: 1em"}
...
## SIR advantages{style="font-size: 1em"}
...
## SIR disadvantages{style="font-size: 1em"}
...
## SIR implementations in PsN{style="font-size: 1em"}
...
## SIR Practical Suggestions{style="font-size: 1em"}
...
## Multiple-iteration SIR implementations in PsN{style="font-size: 1em"}
